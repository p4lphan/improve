 ...
 */
final class Version20190226150310 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE username username VARCHAR(160) NOT NULL, CHANGE email email VARCHAR(64) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE username username VARCHAR(180) NOT NULL COLLATE utf8mb4_unicode_ci, CHANGE email email VARCHAR(64) NOT NULL COLLATE utf8mb4_unicode_ci');
    }
}
